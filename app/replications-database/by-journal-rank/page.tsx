...
// The three statistical outcome methods, in the fixed order used by the compact
// per-row outcome string below (index 1..3). Index 0 is the stored `result`
// column. Kept in sync with app/replications-database/page.tsx.
...
// treated as a determinate non-replication; inconclusive / blank / anything else
// is excluded from denominators.
