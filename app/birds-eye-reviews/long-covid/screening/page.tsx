...
import { computeScreeningCounts, type ExtractionRecord } from "./screening-counts";
import retrievalFailures from "@/data/birds_eye_reviews/long_covid/retrieval_failures_2026-03-08.json";
...
export const metadata = {
  ...
  description:
    "Screening records, historical full-text retrieval failures, and extraction accounting for the Long Covid review.",
};
...
/** Use the same exported extraction feed as the dashboard, not stale prisma.json totals. */
function loadExtractions(): ExtractionRecord[] {
  const filePath = path.join(process.cwd(), "data/birds_eye_reviews/long_covid/trial_extractions.jsonl");
...
export default function ScreeningPage() {
  ...
  const counts = computeScreeningCounts(allRows, loadExtractions(), retrievalFailures);
