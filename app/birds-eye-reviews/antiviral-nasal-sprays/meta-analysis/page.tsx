...
export const metadata = {
  title: "Meta-Analysis | Antiviral Nasal Sprays | Bird's Eye Reviews | The Metascience Observatory",
  description:
    "Random-effects meta-analyses (forest plots) of the human clinical trials of antiviral and barrier nasal sprays.",
};
    ...
    <>
      ...
      <main className="container mx-auto px-4 pt-24 pb-16 min-h-screen">
        ...
        <h1 className="font-clarendon font-bold text-3xl mb-2">
          Antiviral Nasal Sprays — Meta-Analysis
        </h1>
