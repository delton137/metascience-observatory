...
export default function ResultsPage() {
  ...
  // The graded-exercise-therapy meta-analysis lives on an opt-in sub-page; only
  // link to it once the pipeline has written its data files.
  const hasGetMetaAnalysis =
    fs.existsSync(dataPath("get_meta_analysis.json")) || fs.existsSync(dataPath("get_prisma.json"));
    ...
    <>
      ...
      <main className="container mx-auto px-2 pt-24 pb-16 min-h-screen">
        ...
        <div className="mb-4 flex flex-wrap gap-2">
          ...
          {hasGetMetaAnalysis && (
            <Link
              href="/birds-eye-reviews/me-cfs/graded-exercise-therapy"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-blue-200 bg-blue-50 text-blue-700 hover:bg-blue-100 transition-colors text-sm font-medium"
            >
              Graded Exercise Therapy — Meta-analysis &rarr;
            </Link>
          )}
        </div>
